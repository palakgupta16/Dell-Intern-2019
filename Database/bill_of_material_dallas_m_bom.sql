...
--
-- Table structure for table `dallas_m_bom`
--

DROP TABLE IF EXISTS `dallas_m_bom`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dallas_m_bom` (
...
--
-- Dumping data for table `dallas_m_bom`
--

LOCK TABLES `dallas_m_bom` WRITE;
/*!40000 ALTER TABLE `dallas_m_bom` DISABLE KEYS */;
/*!40000 ALTER TABLE `dallas_m_bom` ENABLE KEYS */;
UNLOCK TABLES;
